...
function maxValue(game, depth, beta) {
    ...
    // console.log(game.getValidMoves().length + " valid moves");
    // console.log(possibleMoves.length + " moves being considered")
...
export default function beamSearch(game, depth = 4, beta = 5) {
    if (game.player === 1) {
